...
public class NaturalElements {
     ...
     */
    public static void placeWhiteFlowers(GameWorld gameWorld, Vec2d pos, int type){
        GameObject flowers = new GameObject(gameWorld, 2);

        if(type > 2 || type < 0) type = 0;
        if(type == 0) {
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(2, 11).smult(32), new Vec2d(32, 32));
            flowers.addComponent(sprite);
        } else if(type == 1){
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(2, 10).smult(32), new Vec2d(32, 32));
            flowers.addComponent(sprite);
        } else{
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(0, 6).smult(32), new Vec2d(32, 32));
            flowers.addComponent(sprite);

            flowers.addComponent(new CollisionComponent(new CircleShape(new Vec2d(1,1), .5), true, true,
                    FinalGame.OBJECT_LAYER, FinalGame.OBJECT_MASK));
        }
     ...
     * @param type integer in 0 small patch, 1 large patch, 2 trunk
     */
    public static void placeRedFlowers(GameWorld gameWorld, Vec2d pos, int type){
        GameObject flowers = new GameObject(gameWorld, 2);

        if(type > 2 || type < 0) type = 0;
        if(type == 0) {
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(1, 11).smult(32), new Vec2d(32, 32));
            flowers.addComponent(sprite);
        } else if(type == 1){
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(1, 10).smult(32), new Vec2d(32, 32));
            flowers.addComponent(sprite);
        } else{
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(0, 9).smult(32), new Vec2d(32, 32));
            flowers.addComponent(sprite);
     ...
     * @param type integer in 0 small patch, 1 large patch, 2 trunk
     */
    public static void placeYellowFlowers(GameWorld gameWorld, Vec2d pos, int type){
        GameObject flowers = new GameObject(gameWorld, 2);

        if(type > 2 || type < 0) type = 0;
        if(type == 0) {
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(2, 9).smult(32), new Vec2d(32, 32));
            flowers.addComponent(sprite);
        } else if(type == 1){
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(1, 8).smult(32), new Vec2d(32, 32));
            flowers.addComponent(sprite);
        } else{
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(0, 8).smult(32), new Vec2d(32, 32));
            flowers.addComponent(sprite);
     ...
     * @param type integer in 0 small patch, 1 large patch, 2 trunk
     */
    public static void placePinkFlowers(GameWorld gameWorld, Vec2d pos, int type){
        GameObject flowers = new GameObject(gameWorld, 2);

        if(type > 2 || type < 0) type = 0;
        if(type == 0) {
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(1, 9).smult(32), new Vec2d(32, 32));
            flowers.addComponent(sprite);
        } else if(type == 1){
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(1, 8).smult(32), new Vec2d(32, 32));
     ...
     */
    public static void placeRockFlowers(GameWorld gameWorld, Vec2d pos, int color){
        GameObject rockFlowers = new GameObject(gameWorld, 2);

        if(color == 0) {
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(2, 6).smult(32), new Vec2d(32, 32));
            rockFlowers.addComponent(sprite);

            rockFlowers.addComponent(new CollisionComponent(new CircleShape(new Vec2d(1,1), .5), true, true,
                    FinalGame.OBJECT_LAYER, FinalGame.OBJECT_MASK));
        } else {
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(2, 7).smult(32), new Vec2d(32, 32));
            rockFlowers.addComponent(sprite);
     ...
     */
    public static void placeCactus(GameWorld gameWorld, Vec2d pos, int size){
        GameObject cactus = new GameObject(gameWorld, 2);

        if(size == 0) {
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(0, 10).smult(32), new Vec2d(32, 32));
            cactus.addComponent(sprite);
            cactus.addComponent(new CollisionComponent(new CircleShape(new Vec2d(1,1.5), .2), true, true,
                    FinalGame.OBJECT_LAYER, FinalGame.OBJECT_MASK));


        } else if(size == 1) {
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(3, 10).smult(32), new Vec2d(32, 32));
            cactus.addComponent(sprite);
            cactus.addComponent(new CollisionComponent(new CircleShape(new Vec2d(1,1.5), .2), true, true,
                    FinalGame.OBJECT_LAYER, FinalGame.OBJECT_MASK));
            ...
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(4, 10).smult(32), new Vec2d(32, 32));
            cactus.addComponent(sprite);
            ...
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(0, 11).smult(32), new Vec2d(32, 32));
            cactus.addComponent(sprite);
     ...
     * @param pos location in game world
     */
    public static void placeStump(GameWorld gameWorld, Vec2d pos){
        GameObject stump = new GameObject(gameWorld, 2);

        SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(0, 10).smult(32), new Vec2d(32, 32));
        stump.addComponent(sprite);
        stump.addComponent(new CollisionComponent(new CircleShape(new Vec2d(1,7), .5), true, true,
                FinalGame.OBJECT_LAYER, FinalGame.OBJECT_MASK));
     ...
     */
    public static void placeBush(GameWorld gameWorld, Vec2d pos, int size){
        GameObject bush = new GameObject(gameWorld, 2);

        if(size == 0) {
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(4, 12).smult(32), new Vec2d(32, 32));
            bush.addComponent(sprite);
            bush.addComponent(new CollisionComponent(new CircleShape(new Vec2d(1,1.5), .1), true, true,
                    FinalGame.OBJECT_LAYER, FinalGame.OBJECT_MASK));
        } else if(size == 1) {
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(4, 11).smult(32), new Vec2d(32, 32));
            bush.addComponent(sprite);
            bush.addComponent(new CollisionComponent(new CircleShape(new Vec2d(1,1.5), .2), true, true,
                    FinalGame.OBJECT_LAYER, FinalGame.OBJECT_MASK));
        } else if(size == 2) {
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(3, 11).smult(32), new Vec2d(32, 32));
            bush.addComponent(sprite);

            bush.addComponent(new CollisionComponent(new CircleShape(new Vec2d(1,1.5), .5), true, true,
                    FinalGame.OBJECT_LAYER, FinalGame.OBJECT_MASK));
        } else {
            SpriteComponent sprite = new SpriteComponent(FinalGame.getSpritePath("tile_sprite_sheet"),
                    new Vec2d(0, 0), new Vec2d(2, 2), new Vec2d(4, 13).smult(32), new Vec2d(32, 32));
            bush.addComponent(sprite);

            bush.addComponent(new CollisionComponent(new CircleShape(new Vec2d(1,1.5), .3), true, true,
                    FinalGame.OBJECT_LAYER, FinalGame.OBJECT_MASK));
        }
