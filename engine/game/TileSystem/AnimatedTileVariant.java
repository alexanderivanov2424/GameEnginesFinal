...
public class AnimatedTileVariant extends TileVariant{
    ...
    public AnimatedTileVariant(String spriteSheetPath, Vec2d cropStart, Vec2d cropSize, int frames, Vec2d cropShift) {
        super(spriteSheetPath, cropStart, cropSize);
        this.frames = frames;
